...
/**
 * This class is is used to layout a 3 column layout with header
 *
...
class Layout3Col extends Layout {
	...
	public function __construct($page, $hdr, $col1, $col2, $col3, $width1 = '293px', $width2 = '293px', $width3 = '293px') {
