 ...
 * @version	1.0.0 - with callback and better no results handling added by Wendt Withers
 */
(function($){
			...
			_google_search.setSearchCompleteCallback(this, 
				...
				function(){
					...
					if (_google_search.results && _google_search.results.length > 0) {
						...
						jquery_object.html('<div class="no-results"><p class="first-child">Your search - <strong>'+o.search_text+'</strong> - did not match any documents.</p><p class="second-child">Suggestions:</p><ul><li>Make sure all words are spelled correctly.</li><li>Try different keywords.</li><li>Try more general keywords.</li></ul></div>');
					}
				}
	...
	$.fn.gSearch.defaults =
	{
		...
		// function to call when results loaded
		callback : null
	};
