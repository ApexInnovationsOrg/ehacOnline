// This is an attempt by HealthStream to fix the results-not-being-saved-on-LMS issue
...
//Setters
	SetFailedWithScore: function(intScore, intMaxScore, intMinScore){
		this.sendPipeMessageToLMS("#pipeMessage_SetFailedWithScore:"+intScore+":"+intMaxScore+":"+intMinScore);
	},
	SetPassedWithScore: function(intScore, intMaxScore, intMinScore){
		this.sendPipeMessageToLMS("#pipeMessage_SetPassedWithScore:"+intScore+":"+intMaxScore+":"+intMinScore);
	},
