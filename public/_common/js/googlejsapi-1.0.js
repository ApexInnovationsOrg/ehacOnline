...
if (!window['google']['loader']) {
    ...
    google.loader.AdditionalParams = ''; (function() {
        ...
        function(a, b, c) {
            ...
            var f = a;
            c = c || {};
            if (a instanceof Array || a && typeof a == "object" && typeof a[B] == "function" && typeof a.reverse == "function") for (var i = 0; i < a[w]; i++) e(a[i]);
            else e(a);
            if (a = M[":" + f]) {
                ...
                else if (i) a.m(b, c) ? l[y](c.callback, 0) : a.load(b, c);
        ...
        google.P = function(a, b) {
            if (b) {
                if (O[w] == 0) {
                    ...
                    else if (D("msie")) o.write("<script defer onreadystatechange='google.loader.domReady()' src=//:><\/script>");
                    else(D("safari") || D("konqueror")) && l[y](S, 10)
                }
                O[q](a)
            } else P(l, "load", a)
        };
        ...
        google[z].J = function() {
            var a = (new Date)[v](),
            b = Math.floor(Math.random() * 1E7);
            return "qid=" + (a.toString(16) + b.toString(16))
        };
        ...
        U[x].g = function(a, b) {
            ...
            if (!this.l) {
                ...
                var e = [];
                for (var f in this.p) f[s](0) == ":" && e[q](f[A](1));
                for (f in this.i) f[s](0) == ":" && this.i[f] && e[q](f[A](1));
                c += "&have=" + j(e[B](","))
            }
        ...
        function(a, b) {
            ...
            if (c[w]) {
                ...
                if (!b && N[":" + this.a] != g && N[":" + this.a].versions[":" + a] != g && !google[z].AdditionalParams && this.l) {
                    ...
                    for (var R in c.properties) if (R && R[s](0) == ":") google[this.a][R[A](1)] = c.properties[R];
        ...
        V[x].L = function(a, b, c) {
            ...
            else if (f == "base_domain") b = "http://" + c[f] + a.uri[A](a.uri.indexOf("/", 7));
            google[this[u]] = {};
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/22c4e39868158a22aac047a2c138a780/",
            "js": "default+en.I.js",
            "css": "default.css",
            "properties": {
                ":JSHash": "22c4e39868158a22aac047a2c138a780",
                ":NoOldNames": false,
                ":Version": "1.0"
            }
        },
